...
namespace DatabaseFirstLINQ
{
    class Problems
    {
        ...
        private void ProblemThree()
        {
            ...
            var productGreaterThanOneFifty = products.Where(p => p.Price > 150);

            foreach (Product product in productGreaterThanOneFifty)
            {
        ...
        private void ProblemFour()
        {
            ...
            var productsWithSLetter = products.Where(product => product.Name.Contains("s"));
        ...
        private void ProblemFive()
        {
            ...
            var registrationYear = users.Where(u => u.RegistrationDate < DateTime.Parse("1/1/2016"));
            
            foreach (User user in registrationYear)
            {
        ...
        private void ProblemSix()
        {
            ...
            // Then print each user's email and registration date to the console.
            var users = _context.Users;
            var registrationYear = users.Where(u => u.RegistrationDate > DateTime.Parse("1/1/2016") && u.RegistrationDate <  DateTime.Parse("1/1/2018"));
        ...
        private void ProblemNine()
        {
            ...
            Console.WriteLine($"Product total = {totalPrice}");
        ...
        private void ProblemTen()
        {
            ...
            var employee = _context.UserRoles
                                   .Include(ur => ur.User)
        ...
        private void ProblemTwelve()
        {
            ...
            {
                Name = "anime figma",
                Description = "Everyone's favorite waifu",
                Price = 100,
            };
        ...
        private void ProblemFourteen()
        {
            ...
            var ProductId = _context.Products.Where(p => p.Name == "anime figma").Select(p => p.Id).SingleOrDefault();
            var userId = _context.Users.Where(u => u.Email == "david@gmail.com").Select(u => u.Id).SingleOrDefault();
        ...
        private void ProblemTwenty()
        {
            ...
            var userToDelete = _context.Users.Where(ur => ur.Email == "oda@gmail.com").SingleOrDefault();
